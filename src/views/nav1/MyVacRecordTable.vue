...
<template>
    <section>
        ...
        <!--列表-->
        <el-table :data="vacRecordList" border @selection-change="selsChange" style="width: 100%;">
    ...
    export default {
        ...
        methods: {
            ...
            getVacList() {
                ...
                this.$ajax.post('http://127.0.0.1:8081/myVacRecord',{
                    userName:this.userName
                }).then((response) => {
                    this.vacRecordList = response.data;
                }).catch((response) => {
                    alert("错误：" + response);
                })
            },
